...
export class FoodsComponent {
  ...
  categories = [
    { name: 'Vegetables', icon: '🥦', items: this.vegetables },
    { name: 'Proteins / Meat', icon: '🍗', items: this.proteins },
    { name: 'Pakistani Foods', icon: '🍛', items: this.pakistaniMain },
    { name: 'Fruits', icon: '🍎', items: this.fruits },
    { name: 'Snacks & Sweets', icon: '🍬', items: this.snacksAndSweets },
    { name: 'Drinks', icon: '🥤', items: this.drinks }
  ];
